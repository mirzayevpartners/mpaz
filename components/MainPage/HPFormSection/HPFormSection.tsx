...
function HPFormSectionCases() {
  const data = [
    { icon: partnerIcon, title: 'partnyor', number: '28' },
    { icon: businessPartnerIcon, title: 'biznes komandamiz', number: '14' },
    { icon: justiceIcon, title: 'məhkəmələr', number: '4300+' },
    { icon: auctionIcon, title: 'tamamlanmış iş', number: '2500' },
  ];
  return (
        ...
        return (
          <div className={'flex flex-col items-center gap-y-2'} key={index}>
            ...
            <div className={'flex flex-col items-center gap-y-[0.375rem]'}>
              <h2 className={'text-[2.5rem] leading-[3.333rem] text-white'}>{item.number}</h2>
  ...
  return (
    <section className={'relative flex min-h-full w-full py-8'}>
      <div className={'absolute inset-0 -z-10 flex flex-[1] flex-col'}>
        <div
          className={'flex-[1] border-b-[3px] border-b-secondGold bg-no-repeat'}
