...
const CookieConsent = () => {
  ...
  return (
    ...
    <div className="fixed z-[9005] bottom-0 left-0 right-0 flex items-center justify-between px-4 py-8 bg-gray-100">
      <span className="text-dark text-base mr-16 700:text-sm 500:!text-xs">
